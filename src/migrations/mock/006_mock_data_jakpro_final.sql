...
- Kesesuaian rencana pengelolaan dengan kondisi terkini per aset', v_pic_id, '2026-09-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyediakan akses terhadap seluruh dokumen kajian dan studi pengalihan aset penugasan yang berada di sisi BP BUMD atau Pemprov, termasuk kajian terdahulu atas opsi pengalihan LRT Jakarta (Jika ada)', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Konsistensi data kondisi aset dengan laporan keuangan Jakpro', v_pic_id, '2026-09-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyediakan akses terhadap seluruh dokumen serah terima aset penugasan dan dokumen kondisi awal aset yang tersimpan di BPAD untuk keperluan rekonstruksi kondisi aset', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketiadaan perbedaan material antara data Jakpro dan catatan BPAD', v_pic_id, '2026-09-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menerima dan memvalidasi Dokumen Rangkuman Kondisi Aset Penugasan Eksisting dari Jakpro serta mengkonfirmasi kesesuaian data dengan catatan aset yang tersimpan di BPAD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kejelasan hambatan dan celah studi per opsi', v_pic_id, '2026-09-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan klarifikasi atas posisi dan pertimbangan yang pernah menghambat eksekusi masing-masing opsi pengalihan LRT Jakarta dari sisi Pemprov dan BP BUMD', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Konfirmasi BP BUMD atas justifikasi', v_pic_id, '2026-09-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan konfirmasi tertulis atas justifikasi yang disusun Jakpro, khususnya atas pertimbangan yang menjadi dasar tidak dipilihnya opsi lain dari perspektif kebijakan Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Konfirmasi kesiapan BP BUMD untuk mendukung proses', v_pic_id, '2026-09-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam pembahasan validasi justifikasi dan memberikan konfirmasi resmi atas kesiapan BP BUMD untuk mendukung proses pengurangan modal, termasuk kesiapan penerbitan dokumen formal yang diperlukan Jakpro untuk memulai persiapan transaksi', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Kesiapan antisipasi pertanyaan kritis dari peserta Rapimtas', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memfasilitasi penyelenggaraan Rapimtas dan memastikan kehadiran seluruh pemangku kepentingan kunci (Gubernur, Pemprov DKI, BPAD, OPD terkait, Jakpro) untuk menghasilkan keputusan yang mengikat atas skema pengurangan modal Pemprov DKI.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kelengkapan penugasan tindak lanjut dalam keputusan/notulen Rapimtas', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memimpin penyelenggaraan Rapimtas dan menerbitkan keputusan/notulen resmi yang meratifikasi skema pengurangan modal Pemprov DKI atas Jakpro serta menugaskan tindak lanjut kepada pihak-pihak yang bertanggung jawab', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Ketepatan waktu penerbitan dokumen formal oleh BP BUMD', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menuntaskan proses analisis oleh penasehat investasi dan konsultan evaluasi yang telah ditunjuk Pemprov DKI, serta menerbitkan dokumen formal yang memberikan persetujuan kepada Jakpro untuk memulai pelaksanaan persiapan transaksi pengurangan modal', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketepatan waktu penyelesaian laporan KJPP', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi aktif dalam proses penilaian aset dengan menyediakan akses penuh kepada KJPP terhadap dokumen kepemilikan, catatan kondisi fisik, dan data pemeliharaan aset LRT Jakarta yang tersimpan di BPAD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kelengkapan daftar kondisi awal', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan persetujuan formal atas dokumen strategi transaksi final sebagai dasar resmi bagi Jakpro untuk memulai proses korporasi (permohonan persetujuan Dewan Komisaris dan RUPS) pada tahap berikutnya', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Ketepatan urutan ketergantungan antar instrumen', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkoordinasikan proses penyusunan dan penerbitan regulasi yang memerlukan tindakan dari Pemprov DKI bersama OPD dan biro hukum terkait, termasuk memastikan harmonisasi antar regulasi', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Jumlah revisi material per instrumen', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menerbitkan seluruh instrumen regulasi yang menjadi tanggung jawab Pemprov DKI sesuai urutan prioritas yang disepakati', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Ketepatan waktu pengumuman hasil RUPS', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Hadir dalam RUPS dan memberikan persetujuan sebagai wakil pemegang saham Pemprov DKI atas seluruh agenda', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kesesuaian PPJB dengan strategi transaksi final yang telah disetujui', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menandatangani PPJB bersama Jakpro sebagai representasi Pemprov DKI selaku pihak yang menjalankan pengurangan modal dan melepaskan kepemilikan aset LRT Jakarta', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Kelengkapan dokumentasi sebagai rekam jejak proses', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memantau pelaksanaan pengurangan modal dan pengalihan aset LRT Jakarta bersama Jakpro untuk memastikan kesesuaian dengan dokumen dan regulasi yang disepakati', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Konsistensi isi akta dengan PPJB dan strategi transaksi yang disepakati', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menandatangani akta pengalihan bangunan/aset LRT Jakarta dan perubahan Perjanjian Penugasan bersama Jakpro, serta menerbitkan Kepgub Pengurangan Modal Disetor Pemprov DKI dan perubahan Pergub Penugasan Aset kepada Jakpro', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Kelengkapan tindak lanjut isu yang tersisa', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam evaluasi efektivitas skema pengalihan dan memberikan arahan atas penyesuaian yang diperlukan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketersediaan data selisih tarif vs biaya operasional per aset', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyediakan data historis subsidi dan transfer Pemprov kepada Jakpro per aset penugasan (JIS, JIV, TIM) untuk keperluan validasi', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketersediaan data selisih subsidi dijanjikan vs terealisasi', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi akurasi data subsidi per aset sebelum digunakan sebagai data dasar resmi', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketersediaan analisis sensitivitas untuk asumsi utama', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyediakan data makroekonomi dan kebijakan yang diperlukan sebagai masukan model', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketersediaan skenario sensitivitas', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memvalidasi metodologi dan asumsi utama sebelum model difinalisasi dan digunakan dalam negosiasi formal', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penerimaan definisi oleh BP BUMD', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan kebijakan atas batas yang dapat diterima antara fungsi PSO dan komersial dari perspektif kebijakan Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kejelasan dampak finansial proyeksi', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam pembahasan dan menyepakati batas antara fungsi PSO dan komersial sebelum struktur tarif dirumuskan secara final', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Cakupan aset dalam keputusan resmi', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memimpin proses penyelarasan kebijakan lintas OPD Pemprov dan menerbitkan keputusan resmi (Pergub/Kepgub) yang mengesahkan struktur tarif/PSO', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Jumlah aset yang keluar dari status subsidi implisit', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memastikan mekanisme pencairan kompensasi PSO berjalan sesuai formula dan jadwal yang disahkan. Setiap keterlambatan atau penyimpangan harus terdokumentasi dan diselesaikan sesuai mekanisme yang ditetapkan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Pengurangan kerugian operasional berulang pada aset penugasan', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam evaluasi tahunan efektivitas implementasi tarif/PSO dan memberikan arahan atas penyesuaian yang diperlukan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Konfirmasi BP BUMD atas kerangka kriteria', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas prinsip segmentasi agar selaras dengan mandat BUMD, peran penugasan, dan ekspektasi pengelolaan portofolio dari sisi BPBUMD.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Hasil penilaian dapat diinterpretasikan secara konsisten.', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah parameter penilaian untuk memastikan tidak terjadi bias klasifikasi yang bertentangan dengan mandat strategis BUMD.', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Konfirmasi aset penugasan oleh BP BUMD', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi daftar resmi aset penugasan yang secara legal berada dalam pengelolaan Jakpro berdasarkan catatan Pemprov.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- template dapat dipakai secara seragam lintas aset.', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyediakan akses terhadap data aset penugasan yang tersimpan di BPAD jika diperlukan untuk validasi.', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- peta segmentasi mudah dipahami dan dapat digunakan sebagai alat keputusan.', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan atas hasil segmentasi awal, khususnya untuk aset yang berdampak strategis atau memiliki implikasi tata kelola yang tinggi.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- justifikasi keputusan terdokumentasi memadai.', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah dan memberikan masukan atas arah perlakuan aset yang memerlukan pertimbangan strategis/publik/penugasan.', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Ketersediaan referensi regulasi untuk mekanisme exit aset komersial', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan persetujuan formal atas rencana exit aset yang memerlukan keterlibatan BP BUMD/Pemprov, dan memberikan arahan atas mekanisme exit aset komersial yang diperbolehkan sesuai regulasi daerah', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Konsistensi RKAP dengan hasil klasifikasi portofolio', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memastikan konsistensi arah pengelolaan aset Jakpro dengan kebijakan Pemprov DKI atas portofolio BUMD secara keseluruhan', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Ketepatan waktu pembaruan Mapping Klasifikasi Portofolio', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam tinjauan tahunan untuk aset-aset yang memiliki implikasi kebijakan signifikan bagi Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- hasil evaluasi dapat digunakan sebagai dasar update roadmap portofolio.', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, '- Memberikan masukan atas perubahan eksternal/internal yang berdampak pada penyesuaian prioritas portofolio.
- Berpartisipasi dalam tinjauan tahunan untuk aset-aset yang memiliki implikasi kebijakan signifikan bagi Pemprov', v_pic_id, 'belum mulai');
    -- Strategy
    INSERT INTO strategies (aspect_id, name, code_order, target_percentage)
...
- Penerimaan kerangka oleh Direksi dan BP BUMD', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas prinsip selektivitas kerja sama agar tetap selaras dengan fungsi aset penugasan, mandat publik, dan kepentingan Pemprov/BP BUMD.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- tidak ada area abu-abu dalam tindak lanjut usulan.', v_pic_id, '2026-12-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyetujui kerangka sebelum diberlakukan sebagai standar grup Jakpro.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Cakupan instrumen regulasi (berlaku untuk seluruh BUMD DKI termasuk Jakpro)', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menerbitkan instrumen regulasi yang memperpanjang batas maksimal durasi kontrak sewa aset BUMD DKI dari 5 tahun menjadi minimal 10–15 tahun, sehingga Jakpro dapat menawarkan kontrak jangka panjang yang kompetitif kepada investor dan operator venue profesional', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Jumlah kerja sama di lapangan yang tidak ada dalam Daftar Induk', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi kerja sama yang terkait langsung dengan penugasan Pemprov atau yang memerlukan persetujuan BP BUMD untuk dimodifikasi atau dihentikan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Identifikasi hambatan aksesibilitas yang membatasi komersialisasi', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi kesesuaian target FS dengan kebijakan Pemprov yang berlaku saat ini atas pemanfaatan JIS, JIV, dan TIM.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Estimasi kontribusi pendapatan per program', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas kerja sama dan program monetisasi yang selaras dengan fungsi dan mandat masing-masing aset', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kualitas dan kesesuaian profil operator dengan kebutuhan JIS dan Velodrome', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memfasilitasi akses bagi operator venue management internasional yang berminat bekerja sama dengan Jakpro, termasuk dalam hal perizinan dan koordinasi dengan OPD yang relevan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Komitmen OPD terkait atas penyelesaian hambatan', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memfasilitasi koordinasi dengan OPD terkait (Dinas Perhubungan, Dinas Pekerjaan Umum, dan lainnya) untuk menyelesaikan daya dukung aksesibilitas aset penugasan yang belum tuntas sejak pembangunan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Jumlah peluang pendapatan baru yang teridentifikasi per kategori', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas arah pengembangan model pendapatan yang selaras dengan kebijakan monetisasi BUMD Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penurunan pertanyaan klarifikasi Direksi per proposal', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memastikan proses persetujuan kerja sama strategis di level BP BUMD menggunakan output kerangka evaluasi Jakpro sebagai salah satu bahan tinjauan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penurunan insiden penggunaan aset tanpa izin', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi bahwa SOP Pemanfaatan Aset Jakpro dapat diberlakukan terhadap OPD Pemprov DKI, dan memfasilitasi sosialisasi SOP kepada seluruh OPD yang pernah menggunakan atau berpotensi menggunakan aset Jakpro', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Persentase mitra yang dimonitor menggunakan KPI yang disepakati', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam tinjauan untuk kerja sama yang bernilai material atau terkait aset penugasan Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penerimaan dokumen arah kapabilitas oleh Direksi', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas kapabilitas kunci yang diperlukan dari perspektif transformasi BUMD yang diharapkan Pemprov DKI untuk Jakpro ke depan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kesesuaian posisi tujuan dengan kebutuhan bisnis yang nyata', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan dan arahan terkait redeployment SDM', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Jumlah regulasi yang diterbitkan (SK dan Ingub/Insekda) dan jumlah proyek strategis yang tercakup dalam roadmap PMO.', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'BP BUMD bertindak sebagai koordinator substansi, dengan memfasilitasi pembahasan dan me-review SK Gubernur sebelum pengajuan ke Gubernur.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketersediaan daftar jenis isu yang dapat dieskalasi langsung', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menetapkan jalur eskalasi formal PMO Jakpro ke BP BUMD dan Gubernur DKI Jakarta, termasuk mekanisme akses langsung untuk isu yang memerlukan keputusan lintas OPD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Potensi tumpang tindih peran teridentifikasi dengan jelas.', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menerbitkan instrumen formal yang mengakui peran dan kewenangan PMO Transformasi Jakpro dari sisi BP BUMD sebagai dasar legitimasi PMO dalam berkoordinasi dengan OPD dan BPAD.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Ketepatan identifikasi tonggak yang bergantung pada keputusan Pemprov', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan atas peta jalan transformasi terintegrasi', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Persentase inisiatif transformasi yang tercakup dalam risk register terstandar.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'BP BUMD melakukan review risiko strategis utama yang berdampak lintas BUMD atau memerlukan intervensi kebijakan Pemprov.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Standar status dan dapat diterapkan lintas workstream', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan dan arahan terkait mekanisme pemantauan, alat kerja, dan jalur eskalasi', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Kelengkapan action tracker untuk masing-masing hambatan', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi aktif dalam forum tinjauan dengan perwakilan yang memiliki kewenangan untuk memberikan keputusan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Persetujuan perubahan tercatat sesuai tata kelola.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah perubahan yang material terhadap target implementasi dan memberi arahan bila deviasinya signifikan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Jumlah isu yang mendapat keputusan dalam jadwal yang ditetapkan', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menjadi jembatan formal antara PMO Jakpro, Pemprov, dan OPD terkait, memastikan semua isu mendapat perhatian pada level yang tepat dan terdokumentasi agar dapat ditindaklanjut', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Rekomendasi desain fungsi pengendalian transformasi ditetapkan maksimal X bulan setelah evaluasi selesai.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam evaluasi dan memberikan arahan atas bentuk pelembagaan fungsi PMO yang sesuai dengan tata kelola BUMD jangka panjang.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kesesuaian prioritas informasi dengan kebutuhan pengambilan keputusan.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas kebutuhan informasi minimum yang perlu tersedia untuk mendukung fungsi pengawasan dan pengambilan keputusan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Terdapat hubungan yang jelas antara prioritas use case dan kebutuhan manajemen.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah prioritas use case dan memberi masukan atas area yang paling krusial untuk dipantau dari sisi pembinaan/pengawasan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Hubungan kerja implementasi tergambar jelas.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas mekanisme pelaporan dan titik kendali implementasi sistem yang perlu dipantau.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Nota Kesepahaman Teknis (Technical Agreement) antara Jakpro dan BP BUMD terkait akses data dan utilisasi platform.', '- Relevansi data dengan kebutuhan pengawasan BP BUMD, kejelasan batasan akses, dan keandalan dashboard.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, '- Menyampaikan kebutuhan informasi strategis dan indikator yang dibutuhkan untuk fungsi pengawasan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Tabel data dapat digunakan sebagai dasar cleansing dan integrasi.', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah kecukupan identifikasi sumber data untuk memastikan kebutuhan monitoring strategis dapat dipenuhi.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Aturan kualitas data cukup jelas untuk diterapkan.', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan atas definisi indikator utama yang akan digunakan dalam pelaporan dan pengawasan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kebutuhan kontrol dan monitoring telah tercakup dalam desain.', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah apakah desain sistem mencakup kebutuhan monitoring, audit trail, dan visibilitas yang dibutuhkan.', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Tingkat keselarasan format monitoring dengan kebutuhan pengawasan strategis BP BUMD.', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Pemantauan kinerja secara keberlanjutan oleh BPBUMD.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Batasan pemanfaatan dan ketentuan keamanan data.', '- Jumlah data domain dan indikator yang terintegrasi serta tersedia bagi BP BUMD.', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, '- Melakukan review dan persetujuan atas daftar akses dan batasan pemanfaatan data.
- Menggunakan dashboard sebagai sarana utama pemantauan kinerja Jakpro.', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Kejelasan tindak lanjut atas exception data.', v_pic_id, '2029-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah kualitas data hasil migrasi untuk domain yang material bagi kebutuhan monitoring.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Hasil pilot memberikan masukan yang dapat ditindaklanjuti.', v_pic_id, '2029-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah hasil pilot bila diperlukan untuk memastikan sistem mendukung kebutuhan monitoring strategis.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Manual pengguna cukup jelas untuk dipakai mandiri.', v_pic_id, '2029-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mendorong penggunaan sistem resmi dalam forum monitoring dan pengawasan.', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Temuan utilisasi dan kualitas data dapat ditindaklanjuti.', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah utilisasi platform dan memberi masukan bila terdapat area yang belum efektif digunakan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Terdapat dasar evaluasi yang jelas untuk perubahan.', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan atas kebutuhan penyempurnaan yang berdampak pada kualitas monitoring dan pengawasan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Tingkat ketergantungan pada kompilasi manual menurun.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah penggunaan output sistem dalam forum pengawasan dan pelaporan resmi.', v_pic_id, 'belum mulai');
    -- Strategy
    INSERT INTO strategies (aspect_id, name, code_order, target_percentage)
...
- Kesesuaian pengelompokan per domain', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan atas proses bisnis yang melibatkan interaksi dengan BP BUMD/Pemprov yang perlu diprioritaskan dalam evaluasi.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Pengurangan titik persetujuan vs kondisi eksisting', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan masukan atas desain proses yang melibatkan interaksi dengan BP BUMD/Pemprov.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Persentase lokakarya yang mencapai kesepakatan', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'N.A', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Hubungan antara bottleneck dan dampak proses dapat dijelaskan.', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menelaah hasil identifikasi bottleneck terutama pada keputusan yang berdampak strategis atau material.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kejelasan batas kewenangan', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas area keputusan yang memerlukan review, rekomendasi, atau persetujuan BPBUMD sesuai kewenangan.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Pengurangan waktu siklus vs kondisi eksisting', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam uji coba implementasi untuk proses yang melibatkan interaksi dengan BP BUMD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Tingkat kelulusan evaluasi pemahaman', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi bahwa SOP konsisten dengan kebijakan tata kelola BUMD dan memberikan konfirmasi formal atas SOP yang melibatkan BP BUMD', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Implikasi kebijakan terhadap portofolio bisnis Jakpro', 'Tingkat eksplisitnya arahan peran Jakpro.', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'BP BUMD melakukan koordinasi strategis dengan Bappeda untuk memastikan arah pengembangan City Master Developer Jakpro selaras dengan kebijakan pembangunan daerah dan RPJMD DKI Jakarta serta pembagian peran yang jelas.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Jumlah peluang yang dianalisis secara komparatif dan berbasis data ', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'BP BUMD memberikan arahan kebijakan serta kerangka evaluasi atas hasil kajian peluang bisnis City Master Developer untuk memastikan kesesuaiannya dengan mandat dan portofolio BUMD daerah.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'BP BUMD mereview dan memvalidasi keselarasan antara peluang bisnis yang diusulkan dengan kapabilitas keuangan, aset, dan tata kelola Jakpro dari perspektif pemegang saham daerah.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Jumlah institusi kunci yang memberikan persetujuan atau dukungan tertulis', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'BP BUMD memfasilitasi komunikasi dan advokasi kebijakan dengan pihak legislatif dan eksekutif daerah untuk memastikan dukungan formal terhadap implementasi model strategic holding Jakpro.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penerimaan model oleh Direksi dan BP BUMD', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan kebijakan atas model perusahaan strategic holding yang sesuai dengan arah transformasi BUMD DKI Jakarta secara keseluruhan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penerimaan matriks oleh BP BUMD', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyetujui kerangka pembagian fungsi perusahaan induk vs anak usaha sebelum roadmap transisi disusun', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Penerimaan roadmap oleh Direksi dan BP BUMD', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas tahapan transisi (milestones) yang harus memperoleh persetujuan BP BUMD/Pemprov sebelum dieksekusi', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Dokumen memenuhi standar regulasi dan praktik tata kelola BUMD', v_pic_id, '2027-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan review dan persetujuan formal atas RBJPP Revisi.', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kelancaran perubahan struktural tanpa gangguan operasional', v_pic_id, '2030-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menerbitkan persetujuan formal atas perubahan struktural yang memerlukan keterlibatan BP BUMD/Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penerimaan Daftar Mandat Entitas oleh Direksi dan BP BUMD', v_pic_id, '2030-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Mengkonfirmasi mandat entitas setiap anak usaha selaras dengan kebijakan tata kelola BUMD dan tidak bertentangan dengan peraturan perundangan yang berlaku', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Keselarasan kerangka KPI dengan sistem KPI BP BUMD', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas KPI yang harus ada di level perusahaan induk dari perspektif akuntabilitas yang diharapkan BP BUMD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Keselarasan KPI entitas dengan model perusahaan Strategic Holding', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyetujui kerangka KPI perusahaan induk sebelum dikaskadekan ke seluruh entitas', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Penerimaan kerangka oleh Direksi dan BP BUMD', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas format dan konten laporan yang harus disediakan Jakpro kepada BP BUMD atas kinerja seluruh entitas dalam grupnya', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kewajiban penggunaan kerangka evaluasi investasi dalam kebijakan seperti yang ditetapkan dalam strategi 2B', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas batasan kebijakan alokasi modal yang harus selaras dengan ketentuan penggunaan PMD dan kebijakan investasi BUMD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Persentase tonggak roadmap yang berhasil dieksekusi sesuai jadwal', v_pic_id, '2030-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi dalam evaluasi efektivitas transisi dan memberikan arahan atas penyesuaian yang diperlukan untuk memastikan arah transisi tetap selaras dengan kebijakan tata kelola BUMD', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Tingkat implementasi rekomendasi setelah disetujui', v_pic_id, '2030-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Menyetujui penyesuaian roadmap yang memerlukan perubahan dalam tatanan regulasi atau kebijakan Pemprov', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Penerimaan Peta Pemangku Kepentingan oleh Direksi', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan arahan atas pemangku kepentingan kunci dari perspektif Pemprov yang harus diprioritaskan Jakpro', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Kejelasan pola hambatan komunikasi yang teridentifikasi', v_pic_id, '2027-03-31', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan perspektif dari sisi Pemprov atas hambatan komunikasi yang selama ini terjadi antara Jakpro dan OPD/Dinas terkait', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Persentase keterlibatan dalam rencana yang terlaksana sesuai jadwal', v_pic_id, '2028-06-30', 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berkoordinasi dengan Jakpro untuk memastikan program keterlibatan pemangku kepentingan mencerminkan posisi dan kebijakan Pemprov DKI secara konsisten', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
...
- Persentase umpan balik yang ditindaklanjuti dalam keputusan bisnis', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Berpartisipasi aktif dalam program keterlibatan Jakpro dengan kelompok pemangku kepentingan yang memiliki relevansi kebijakan', v_pic_id, 'belum mulai');
    -- Activity Group
    INSERT INTO activity_groups (strategy_id, name, code_order, target_percentage)
...
- Tren skor kepercayaan pemangku kepentingan', v_pic_id, NULL, 'belum mulai')
    ...
    INSERT INTO sub_action_plans (action_plan_id, name, pic_user_id, status)
    VALUES (v_ap_id, 'Memberikan feedback secara berkala dari sisi BP BUMD atas kualitas hubungan dan komunikasi Jakpro dengan pemangku kepentingan', v_pic_id, 'belum mulai');
    -- Action Plan
    INSERT INTO action_plans (activity_group_id, name, code_order, target_percentage, output, indicator, pic_user_id, target_end_date, status)
