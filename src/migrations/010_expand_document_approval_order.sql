-- =========================
-- EXPAND DOCUMENT APPROVAL ORDER: remove hardcoded 2-limit
-- =========================

-- Drop the old constraint that limits approval_order to 1 or 2
ALTER TABLE document_approvals
  DROP CONSTRAINT IF EXISTS chk_document_approvals_order;

-- Add new constraint: approval_order must be >= 1 (no upper limit)
ALTER TABLE document_approvals
  ADD CONSTRAINT chk_document_approvals_order
